...
locations = {
    ...
    RegionNames.KAMIKI_VILLAGE: {
        ...
        "Kamiki Village - Buried Chest near Komuso": LocData(0x01030000, type=LocationType.BURIED_CHEST),
        "Kamiki Village - Underwater Chest 1": LocData(0x01030015, type=LocationType.UNDERWATER_CHEST_SHALLOW),
        "Kamiki Village - Underwater Chest 2": LocData(0x01030007, type=LocationType.UNDERWATER_CHEST_SHALLOW),
        "Kamiki Village - Underwater chest in lake near Kushi's house": LocData(0x01030014, type=LocationType.UNDERWATER_CHEST),
        ...
        "Kamiki Village - Buried chest in field": LocData(0x01030006, type=LocationType.BURIED_CHEST),
    ...
    RegionNames.ORANGES_HOUSE: {
        "Kamiki Village - Chest buried in Oranges' house": LocData(0x01030008, type=LocationType.BURIED_CHEST)
    },
    ...
    RegionNames.KAMIKI_ISLANDS: {
        ...
        "Kamiki Village - West Island buried chest": LocData(0x01030025, type=LocationType.BURIED_CHEST),
        # Waterlily tutorial,
        "Kamiki Village - East Islands Sun fragment chest": LocData(0x0103001C),
        "Kamiki Village - East Islands Stray Bead Chest": LocData(0x01030002),
        "Kamiki Village - East Islands Buried Chest": LocData(0x01030001, type=LocationType.BURIED_CHEST),
    }
}
