...
exits = {
    RegionNames.RIVER_OF_THE_HEAVENS_KAMIKI: [ExitData(
        ...
        ExitData(RegionNames.STONE_KAMIKI, one_way=True, required_items_events=["Cursed Kamiki - Cutting the peach"])],
...
locations = {
    RegionNames.RIVER_OF_THE_HEAVENS_KAMIKI: {
        "River of the Heavens - Ledge Chest": LocData(container_check_id(MapIds.RIVER_OF_THE_HEAVENS, 0)),
        # spawn_idx=0, Holy Bone S
        "River of the Heavens - Yomigami": LocData(brush_check_id(22), type=LocationType.CONSTELLATION),
        # Brush acquisition (bit 22)
    },
    RegionNames.RIVER_OF_THE_HEAVENS_NAGI: {
        "River of the Heavens - Astral Pouch": LocData(container_check_id(MapIds.RIVER_OF_THE_HEAVENS, 12)),
        # spawn_idx=12, Astral Pouch
    }
}
