...
# Rule for night time checks
def night_check_rule(state:CollectionState,world:"OkamiWorld")->bool:
...
# Player needs to have either solar flare, or lit the torches by solving the sand room.
